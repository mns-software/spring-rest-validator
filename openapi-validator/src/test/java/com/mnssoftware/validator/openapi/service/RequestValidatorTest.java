...
import com.mnssoftware.validator.openapi.service.openapi.NormalisedPath;
import com.mnssoftware.validator.openapi.service.openapi.RequestValidator;
...
public class RequestValidatorTest {
    ...
    public void validateRequest_pathParams_happyPath() {
        SerializableParameter parameter = ValidatorTestUtil.stringParam(true, "path");
        when(operation.getParameters()).thenReturn(singletonList(parameter));
    ...
    public void validateRequest_queryParams_happyPath() {
        SerializableParameter parameter = ValidatorTestUtil.stringParam(true, "query");
