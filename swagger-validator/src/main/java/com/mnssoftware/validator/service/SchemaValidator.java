...
import static com.mnssoftware.validator.service.ValidationKeyMessage.DEFAULT;
import static com.mnssoftware.validator.service.ValidationKeyMessage.NOT_NULL;
...
public class SchemaValidator {
  ...
  public Set<ValidationMessage> validate(final Object value, final Model schema) {
    ...
    try {
      ...
      return Collections.singleton(buildValidationMessage(DEFAULT.getCode(), null));
    }
  }
    ...
    try {
      ...
      if (normalisedValue == null) {
        if (schema.getRequired()) {
          return Collections.singleton(buildValidationMessage(NOT_NULL.getCode(), schema.getName()));
        } else
